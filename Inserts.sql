...
/* Datos a Clasificaciones de Juegos */
insert into dim_clasificaciones (nombre_clasificacion) values
("Todos"),
("Todos +10"),
("Adolescentes"),
("Maduro +17"),
("Adultos Unicamente +18"),
("Aún sin clasificar");

/* Datos a Juegos */
insert into dim_juegos (nombre, id_categoria, id_clasificacion) values
('Mortal Kombat 11', 7, 5),
('Resident Evil Village', 1, 4),
('Call of Duty MW2', 5, 5),
('Street Fighter 5', 7, 3),
('Mortal Kombat XL', 7, 5),
('Outlast Trinity', 1, 5),
('Elden Ring', 2, 4),
('God of War', 4, 4),
('God of War Ragnarok', 4, 4),
('Uncharted Trilogy', 4, 2),
('Dragon Ball Fighterz', 7, 1),
('Battlefield 5', 5, 4),
('Bonderlands 3', 5, 4),
('Resident Evil 4 Remake', 1, 5),
('Hitman', 9, 5),
('Cuphead', 6, 1),
('Mario Bros', 6, 1),
('Detroit Become Human', 4, 3);
...
/* Datos a Ventas*/
insert into hecho_ventas (id_usuario, id_producto, fecha) values 
(10, 18, curdate()),
(1, 12, curdate()),
(9, 8, curdate()),
(4, 1, curdate()),
